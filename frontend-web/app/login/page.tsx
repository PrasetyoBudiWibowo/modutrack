  ...
  return (
    <AuthCard title="Login">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              className={`w-full px-3 py-2 pr-10 rounded-lg border transition focus:outline-none focus:ring-2 focus:ring-blue-400 ${
        ...
        <button
          type="submit"
          disabled={loading || !dataInput.user_name || !dataInput.password}
          className={`w-full py-2 rounded-lg text-white transition ${
            loading || !dataInput.user_name || !dataInput.password
